...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            for (int i = 0; i < 40; ++i) {
                String inputsDirectoryPath = "C:\\Users\\asus\\Desktop\\projects\\Discrete Math final project template\\Q4\\TestGenerator\\inputs\\";
                ...
                for (Airport airport : airports1) {
                    myWriter.write(airport.code + " " + airport.x + " " + airport.y + " " + airport.name + "\n");
